...
void dram_controller_cfg(void)
{
	...
	reg32_write(DDRC_BASE_REG(0x218), 0x07070707);  //½â¾ö1G·Ö³ÉÁ½²¿·ÖµÄbug         
...
void phyinit_C_initPhyConfig(void)
{
	...
	*/
	...
	/*Ryan: Programming PllCtrl2 to 0x19(3200M/4), 0x7(800M/4), 0xb(1600M/4), 0xa(2400M/4)
					...
					min(MHz)  max (MHz) | [4:0]     
					================================
					937.5     1067      | 11000ï¿½ï¿½b  //0x18
					625       937.5     | 11001ï¿½ï¿½b  //0x19
					468.75    625       | 01010ï¿½ï¿½b  //0xa
					312.5     468.75    | 01011ï¿½ï¿½b  //0xb
					234.4     312.5     | 00110ï¿½ï¿½b  //0x6
					166       234.4     | 00111ï¿½ï¿½b  //0x7
	*/              
