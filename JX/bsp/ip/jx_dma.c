...
//    DMA_CHEN(dma_s->dma) = (0x101<<(dma_s->ch-1));
    ...
    DMA_CFG(0) = 0x1;
    DMA_CHy_CFG_L(0,1) = 0x0;
    DMA_CHy_CFG_H(0,1) = 0x40018;
    DMA_CHy_SAR(0,1) = dma_s->src;
    DMA_CHy_DAR(0,1) = dma_s->dst;
//    DMA_CHy_LLP_L(0,1) = 0x97740;
//    DMA_CHy_LLP_H(0,1) = 0x0;
//    DMA_CHy_QOS(0,1) = 0xb8;
//    DMA_CHy_AXI_ID(0,1) = 0x3000c;
    DMA_CHy_BLK_TS(0,1) = 5;//0xb0;
                                         
    DMA_CHy_CTL_L(0,1) = 0x44100;
//    DMA_CHy_CTL_H(0,1) = 0x40058040;
    DMA_CHEN(0) = 0x101<<0;
}
