...
#define PIN_SWCLK_TCK			GPIO_Pin_14

// SWDIO/TMS Pin
#define PIN_SWDIO_TMS_PORT      GPIOA
#define PIN_SWDIO_TMS			GPIO_Pin_13 
#define PIN_SWDIO_TMS_OUT_DISABLE()		GPIOA->CRH &= ~(0x00F00000); GPIOA->CRH |= 0x00800000; GPIOA->BSRR = PIN_SWDIO_TMS
#define PIN_SWDIO_TMS_OUT_ENABLE()		GPIOA->CRH &= ~(0x00F00000); GPIOA->CRH |= 0x00300000; GPIOA->BRR  = PIN_SWDIO_TMS

// TDI Pin (output)
#define PIN_TDI_PORT			GPIOA
#define PIN_TDI					GPIO_Pin_8

// TDO Pin (input)
#define PIN_TDO_PORT            GPIOA
#define PIN_TDO					GPIO_Pin_9
...
#define LED_CONNECTED			GPIO_Pin_12

// Target Running LED (RED)
#define LED_RUNNING_PORT		GPIOB
#define LED_RUNNING				GPIO_Pin_11
...
static inline void PORT_JTAG_SETUP (void) {
	...
	GPIO_InitStructure.GPIO_Pin = PIN_TDO;
	GPIO_Init(PIN_TDO_PORT, &GPIO_InitStructure);

	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
	GPIO_InitStructure.GPIO_Pin = PIN_SWCLK_TCK | PIN_SWDIO_TMS | PIN_TDI;
	GPIO_Init(PIN_SWCLK_TCK_PORT, &GPIO_InitStructure);

	PIN_nRESET_PORT->BSRR = PIN_nRESET;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_OD;
	GPIO_InitStructure.GPIO_Pin = PIN_nRESET;
	GPIO_Init(PIN_nRESET_PORT, &GPIO_InitStructure);
}
...
static inline void PORT_SWD_SETUP (void) {
	...
	GPIO_InitStructure.GPIO_Pin = PIN_TDI | PIN_TDO;
	GPIO_Init(PIN_TDI_PORT, &GPIO_InitStructure);

	PIN_SWCLK_TCK_PORT->BSRR = PIN_SWCLK_TCK | PIN_SWDIO_TMS;

	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
	GPIO_InitStructure.GPIO_Pin = PIN_SWCLK_TCK | PIN_SWDIO_TMS;
	GPIO_Init(PIN_SWCLK_TCK_PORT, &GPIO_InitStructure);
...
static inline void PORT_OFF (void) {
	...
	GPIO_InitStructure.GPIO_Pin = PIN_SWCLK_TCK | PIN_SWDIO_TMS | PIN_TDI | PIN_TDO;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;
	GPIO_Init(PIN_SWCLK_TCK_PORT, &GPIO_InitStructure);
...
static inline void LED_CONNECTED_OUT (uint32_t bit) {
	if (bit & 1)
		LED_CONNECTED_PORT->BSRR = LED_CONNECTED;
	else
...
static inline void LED_RUNNING_OUT (uint32_t bit) {
	if (bit & 1)
		LED_RUNNING_PORT->BSRR = LED_RUNNING;
	else
...
static inline void DAP_SETUP (void) {
	...
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
	GPIO_InitStructure.GPIO_Pin = LED_CONNECTED | LED_RUNNING;
	GPIO_Init(LED_CONNECTED_PORT, &GPIO_InitStructure);
